...
cat("\n✅ Saved Fig2_ClusterCoverage_Map.png (without labels)\n")
...
cat("\n✅ Saved plot to:", file.path(plot_path, "Fig_Distribution_IWI_2002_2013.png"), "\n")
...
cat("\n✅ Saved descriptive IWI summary table to:\n", output_file, "\n")
...
cat("\n✅ Saved detailed ATT comparison table (with SE & CI) to:", table_path, "\n")
...
cat("\n✅ Saved full faceted figure to:", plot_path, "\n")
...
cat("\n✅ Saved focused six-panel figure to:", plot_path, "\n")
################################################################################
...
print(t_dcdh)
sink()
cat("\n✅ Saved pretrend summary tables and tests to:", table_path, "\n")
...
cat("\n✅ Saved boxplot of pre-treatment coefficients to:", plot_path, "\n")
...
cat("\n✅ Saved detailed dot-whisker pretrend figure to:", plot_path, "\n")
...
cat("\n✅ Loaded all enriched data files with correct funder–sector mapping.\n")
...
cat("\n✅ Prepared long-form data for plotting.\n")
...
cat("\n✅ SUCCESS: Final TWFE Comparison plot saved to /Users/ma/Downloads/analysis/plots/\n")
...
cat("\n✅ SUCCESS: Final dCdH Comparison plot saved to /Users/ma/Downloads/analysis/plots/\n")
